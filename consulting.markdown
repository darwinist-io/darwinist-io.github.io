...
consulting_services:
  ...
  service_categories:
    ...
    healthcare_integration:
      ...
      description: "Expert integration of healthcare applications and systems"
      services:
        ...
        - name: "DICOM Infrastructure Setup"
          ...
          deliverables:
            - "PACS/RIS integration assessment"
        ...
        - name: "Legacy System Modernization"
          description: "Transform outdated healthcare IT systems to modern, interoperable platforms"
          deliverables:
    ...
    clinical_pathways:
      title: "Clinical Pathway Design & Implementation"
      icon: "fas fa-route"
      description: "Design and implement efficient clinical care pathways"
      services:
        - name: "Care Pathway Development"
          description: "Design comprehensive care pathways for specific conditions (ADHD, Mental Health, etc.)"
          deliverables:
            - "Pathway mapping and optimization"
            - "Digital workflow design"
            - "Integration with existing systems"
            - "Staff training and rollout support"
          duration: "2-3 months"
          
        - name: "Digital Front Door Implementation"
          description: "AI-enabled automated triage and patient routing systems"
          deliverables:
            - "Triage algorithm development"
        ...
        - name: "Workflow Optimization"
          description: "Analyze and optimize existing clinical workflows for efficiency"
          deliverables:
    ...
    cloud_infrastructure:
      ...
      icon: "fas fa-cloud"
      description: "Secure, compliant cloud solutions for healthcare"
      services:
    ...
    medical_application_development:
      ...
      services:
        - name: "Clinical Information System Development"
          description: "Build custom clinical information systems with FHIR-native architecture and modern workflow design"
          deliverables:
        ...
        - name: "Medical Device Software Development"
          description: "Develop FDA/CE compliant medical device software applications"
          deliverables:
            ...
            - "Clinical validation and verification testing"
            - "Regulatory submission support"
            - "Post-market surveillance framework"
          duration: "8-18 months"
          
        - name: "Healthcare Web Applications"
          description: "Build modern web applications for healthcare providers using Python, Flask, and Bootstrap"
          deliverables:
        ...
        - name: "DICOM Imaging Applications"
          ...
          deliverables:
            - "DICOM application requirements analysis"
            - "Medical imaging viewer development"
        ...
        - name: "Mobile Health Applications"
          description: "Create secure mobile applications for patient engagement and clinical workflows"
          deliverables:
            - "Mobile app strategy and design"
    ...
    procurement_strategy:
      title: "Healthcare IT Procurement & Strategy"
      icon: "fas fa-handshake"
      description: "Strategic guidance for healthcare technology procurement"
      services:
        - name: "Technology Procurement Strategy"
          description: "Navigate complex healthcare IT procurement processes"
          deliverables:
        ...
        - name: "Digital Transformation Planning"
          description: "Comprehensive digital transformation roadmap for healthcare organizations"
          deliverables:
            - "Current state assessment"
        ...
        - name: "Vendor Management & Integration"
          description: "Manage multiple healthcare technology vendors and ensure seamless integration"
          deliverables:
  ...
  pricing_approach:
    ...
    options:
      ...
      - "Outcome-based pricing for specific implementations"
